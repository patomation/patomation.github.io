...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    var _componentsDrumMachineDrumMachine = __webpack_require__(165);

	    var _componentsDrumMachineDrumMachine2 = _interopRequireDefault(_componentsDrumMachineDrumMachine);

	    var App = _react2['default'].createClass({
	      displayName: 'App',

	      render: function render() {
	        return _react2['default'].createElement('div', { className: 'app' }, _react2['default'].createElement('img', {
	          style: {
	            width: '50%',
	            margin: '0 auto',
	            display: 'block'
	          ...
	          src: './images/header.png' }), _react2['default'].createElement('div', {
	          className: 'padder',
	          style: {
	            paddingTop: '6%',
	            paddingBottom: '6%'
	          } }, _react2['default'].createElement(_componentsDrumMachineDrumMachine2['default'], null)), _react2['default'].createElement('a', { href: 'http://www.soundcloud.com/advolkit' }, _react2['default'].createElement('img', {
	          style: {
	            width: '14%',
	            margin: '0 auto',
	            display: 'block'
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    var Utilities = {
	      ...
	      * Get  Github Path
	      */
	      getGitPath: function getGitPath(gitHubURL, callback) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    var _isJs = __webpack_require__(166);
	    ...
	    var _pad = __webpack_require__(167);
	    ...
	    var DrumMachine = _react2['default'].createClass({
	      ...
	      merge_objects: function merge_objects(obj1, obj2) {
	        var obj3 = {};
	        for (var attrname in obj1) {
	          obj3[attrname] = obj1[attrname];
	        }
	      ...
	      audioFiles: [{
	        name: 'Advolkit_city-01.mp3',
	        hotkey: '1'
	      }, {
	        name: 'Advolkit_city-02.mp3',
	        hotkey: '2' }, {
	        name: 'Advolkit_city-03.mp3',
	        hotkey: '3'
	      }, {
	        name: 'Advolkit_city-04.mp3',
	        hotkey: '4'
	      }, {
	        name: 'Advolkit_city-05.mp3',
	        hotkey: 'q'
	      }, {
	        name: 'Advolkit_city-06.mp3',
	        hotkey: 'w'
	      }, {
	        name: 'Advolkit_city-07.mp3',
	        hotkey: 'e'
	      }, {
	        name: 'Advolkit_city-08.mp3',
	        hotkey: 'r'
	      }, {
	        name: 'Advolkit_city-09.mp3',
	        hotkey: 'a'
	      }, {
	        name: 'Advolkit_city-10.mp3',
	        hotkey: 's'
	      }, {
	        name: 'Advolkit_city-11.mp3',
	        hotkey: 'd'
	      }, {
	        name: 'Advolkit_city-12.mp3',
	        hotkey: 'f'
	      }, {
	        name: 'Advolkit_city-13.mp3',
	        hotkey: 'z'
	      }, {
	        name: 'Advolkit_city-14.mp3',
	        hotkey: 'x'
	      }, {
	        name: 'Advolkit_city-15.mp3',
	        hotkey: 'c'
	      }, {
	        name: 'Advolkit_city-16.mp3',
	        hotkey: 'v'
	      }],
	      // audioFiles: [
	      //   {
	      ...
	      componentDidMount: function componentDidMount() {
	        ...
	        //Set audio instances
	        this.audioFiles.map(function (audio, index) {
	          audioInstances.push(new Audio('images/' + audio.name));
	          hotkeys.push(audio.hotkey);
	        });

	        // Store Audio Instances in state
	        this.setState({
	        ...
	        document.onkeypress = (function (e) {
	          ...
	          console.log(key);
	          console.log(hotkeys.indexOf(key));
	          this.play(hotkeys.indexOf(key));
	        }).bind(this);
	      ...
	      getPads: function getPads() {
	        ...
	        var pads = [];
	        //Set Each Pad
	        pads = this.audioFiles.map((function (audio, index) {
	          //Props
	          var props = {
	            key: index,
	            hotkey: audio.hotkey,
	            topLabel: audio.name.replace('.mp3', ''),
	            bottomLabel: audio.hotkey,
	            style: this.merge_objects(this.style.pad, {
	              opacity: index === this.state.activeIndex ? 0.5 : null
	            }),
	            onClick: _isJs2['default'].ios ? null : this.play.bind(this, index),
	            onTouchStart: _isJs2['default'].ios ? this.play.bind(this, index) : null
	          };
	          //Return react html component
	          return _react2['default'].createElement(_pad2['default'], props);
	        }).bind(this));
	      ...
	      render: function render() {
	        ...
	        return _react2['default'].createElement('div', {
	          ...
	          style: this.merge_objects(this.style.drumMachine, this.props.style) }, pads);
	      }
	    });
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/x/react-web-pack-test/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot apply hot update to " + "drum-machine.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    var Pad = _react2['default'].createClass({
	      displayName: 'Pad',

	      Props: {
	        style: _react2['default'].PropTypes.obj,
	        onClick: _react2['default'].PropTypes.obj,
	        onTouchStart: _react2['default'].PropTypes.obj
	      },
	      ...
	      componetnWillRecieveProps: function componetnWillRecieveProps() {},
	      ...
	      render: function render() {
	        var style = this.merge_objects(this.styles.button, this.props.style);

	        // style.opacity = this.state.active ? 0.5 : null;
	        ...
	        return _react2['default'].createElement('button', props, _react2['default'].createElement('span', { style: this.styles.topLabel }, this.props.topLabel), _react2['default'].createElement('span', { style: this.styles.bottomLabel }, this.props.bottomLabel));
	      }
	    });
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/x/react-web-pack-test/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot apply hot update to " + "pad.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
