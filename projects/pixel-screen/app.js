...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    var _componentsPixelScreenPixelScreen = __webpack_require__(166);

	    var _componentsPixelScreenPixelScreen2 = _interopRequireDefault(_componentsPixelScreenPixelScreen);
	    ...
	    var Layout = _react2['default'].createClass({
	      ...
	      render: function render() {
	        ...
	        return _react2['default'].createElement('div', {
	          className: 'layout',
	          style: this.merge(this.styles.layout, this.props.style) }, _react2['default'].createElement(_header2['default'], {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    var _pixel = __webpack_require__(168);
	    ...
	    var PixelScreen = _react2['default'].createClass({
	      displayName: 'PixelScreen',
	      ...
	      tick: function tick() {
	        console.log('Tick');
	        this.setState({
	          activeColumn: this.state.activeColumn === this.state.columns - 1 ? 0 : this.state.activeColumn + 1
	        });
	      },
	        ...
	        _jquery2['default'].ajax({
	          ...
	          success: (function (data) {
	            ...
	            data.map(function (item) {
	              ...
	              audioFiles.push({ name: item.download_url });
	            });
	            this.setState({
	              soundURLS: items,
	      ...
	      componentDidMount: function componentDidMount() {
	        ...
	        this.getPackSoundFromGithub('city-pack');
	      },

	      getPixels: function getPixels(activeColumnIndex) {

	        var pixels = this.state.audioInstances.map((function (audioInstance, i) {
	      ...
	      getColumns: function getColumns() {
	        ...
	        for (var i = 0; i < this.state.columns; i++) {
	          columns.push(_react2['default'].createElement(_column2['default'], { key: i, active: this.state.activeColumn === i ? true : false }, this.getPixels(i)));
	        }
	        return columns;
	      },
	      ...
	      render: function render() {
	        return _react2['default'].createElement('div', {
	          ...
	          style: this.props.style }, this.getColumns(), _react2['default'].createElement('button', { onClick: this.play }, ' Play '), _react2['default'].createElement('button', { onClick: this.nextFrame }, ' NextFrame '), _react2['default'].createElement('button', { onClick: this.stop }, ' Stop '));
	      }
	    });

	    exports['default'] = PixelScreen;
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/x/react-web-pack-test/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot apply hot update to " + "pixel-screen.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    var Pixel = _react2['default'].createClass({
	      displayName: 'Pixel',

	      Props: {
	        active: _react2['default'].PropTypes.booleon,
	        audio: _react2['default'].PropTypes.string,
	        audioInstance: _react2['default'].PropTypes.object
	      },
	      ...
	      playSound: function playSound() {
	        this.props.audioInstance.audio.currentTime = 0;
	        this.props.audioInstance.audio.play();
	      },

	      //Plays sound when active prop changes
	      componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
	        if (this.state.selected && nextProps.active) {
	          this.playSound();
	        }
	      },

	      render: function render() {
	        var style = _utilities2['default'].clone(this.style);

	        style.backgroundColor = this.state.selected ? this.props.active ? 'yellow' : 'silver' : 'gray';
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/x/react-web-pack-test/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot apply hot update to " + "pixel.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    var Pixel = _react2['default'].createClass({
	      ...
	      render: function render() {
	        var style = _utilities2['default'].merge(this.style);

	        style.backgroundColor = this.props.active ? 'red' : null;
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/x/react-web-pack-test/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot apply hot update to " + "column.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
