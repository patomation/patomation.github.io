	  ...
	  (function () {
	    ...
	    var DrumMachine = _react2['default'].createClass({
	      ...
	      getInitialState: function getInitialState() {
	        return {
	          audioInstances: null,
	          hotkeys: ['1', '2', '3', '4', 'q', 'w', 'e', 'r', 'a', 's', 'd', 'f', 'z', 'x', 'c', 'v']
	        };
	      },
	      ...
	      getPackSoundFromGithub: function getPackSoundFromGithub(packName) {
	        _jQuery2['default'].ajax({
	          ...
	          success: (function (data) {
	            ...
	            this.setState({
	              soundURLS: items,
	              audioInstances: audioInstances.reverse() //Reverse audio instances for expected MPC layout
	            });
	          }).bind(this)
	        });
	      },
	      ...
	      componentDidMount: function componentDidMount() {
	        ...
	        document.onkeypress = (function (e) {
	          ...
	          console.log(key);
	          console.log(this.state.hotkeys.indexOf(key));
	          this.play(this.state.hotkeys.indexOf(key));
	        }).bind(this);
	      ...
	      getPads: function getPads(audioInstances) {
	        //Set Variables
	        var pads = [];

	        // Wait for state audio instance callback stuff to happen and state will update itself and run this code when ready.
	        if (audioInstances) {

	          //Set Each Pad
	          pads = audioInstances.map((function (audio, index) {
	            //Props
	            var props = {
	              key: index,
	              topLabel: audio.name,
	      ...
	      render: function render() {
	        return _react2['default'].createElement('div', {
	          ...
	          style: this.merge_objects(this.style.drumMachine, this.props.style) }, this.getPads(this.state.audioInstances));
	      }
	    });
