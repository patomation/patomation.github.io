...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    var _componentsLayout = __webpack_require__(163);

	    var _componentsLayout2 = _interopRequireDefault(_componentsLayout);

	    var _componentsWavesurferWavesurfer = __webpack_require__(166);

	    var _componentsWavesurferWavesurfer2 = _interopRequireDefault(_componentsWavesurferWavesurfer);

	    //Images

	    var _imagesCHAT2Gif = __webpack_require__(168);
	    ...
	    var App = _react2['default'].createClass({
	      ...
	      render: function render() {
	        return _react2['default'].createElement('div', { className: 'app' }, _react2['default'].createElement(_componentsLayout2['default'], null, 'Hello World', _react2['default'].createElement('br', null), _react2['default'].createElement('img', { src: _imagesCHAT2Gif2['default'] }), _react2['default'].createElement(_componentsWavesurferWavesurfer2['default'], null)));
	      }
	    });
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    exports['default'] = _react2['default'].createClass({
	      ...
	      render: function render() {
	        return _react2['default'].createElement('div', { className: 'layout' }, _react2['default'].createElement(_header2['default'], null), _react2['default'].createElement('div', { className: 'content' }, this.props.children), _react2['default'].createElement(_footer2['default'], null));
	      }
	    });
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    exports["default"] = _react2["default"].createClass({
	      ...
	      render: function render() {
	        return _react2["default"].createElement("div", { className: "header" }, "Header");
	      }
	    });
	    module.exports = exports["default"];
	    ...
	    exports['default'] = _react2['default'].createClass({
	      ...
	      componentDidMount: function componentDidMount() {
	        ...
	        (0, _jquery2['default'])(document).ready((function () {
	          ...
	          WaveSurfer.load('./audio/clip2.mp3');
	          //Set default loop regions/ export region
	          WaveSurfer.on('ready', (function () {
	            console.log('READY');
	            // WaveSurfer.play();
	            var regionLength = this.getRegionLength(120, 4);
	          ...
	          //TODO: NOT WORKING!!!!!!
	          WaveSurfer.on('mouseup', function (e) {
	      ...
	      // Pass in the wave surfer object and it should cut the selection.
	      cut: function cut(instance) {
	        // var selection = instance.getSelection();
	        var selection = {};
	        selection.startPosition = this.state.region.start;
	        selection.endPosition = this.state.region.end;
	        if (selection) {
	      ...
	      play: function play(section) {
	        console.log(section);
	        console.log(this.state.region);
	        var regionStart = this.state.region.start;
	        var secPerBeat = this.getSecPerBeat(120);

	        var start = regionStart + section * secPerBeat;
	        this.state.wavesurfer.play(start);
	      },

	      getRegionLength: function getRegionLength(bpm, bars) {
	        var secPerBeat = 60 / bpm,

	        //60sec/120bpm = 0.5sec
	        beats = bars * 4,

	        //4 beats per bar = 16 beats
	        segmentLength = secPerBeat * beats; // 0.5sec * 16beats = 8sec
	        return segmentLength; //Returns seconds
	      },
	      getSecPerBeat: function getSecPerBeat(bpm) {
	        var secPerBeat = 60 / bpm; //60sec/120bpm = 0.5sec
	        return secPerBeat; //Returns seconds
	      },

	      getButton: function getButton(label, onClick) {
	      ...
	      'export': function _export() {
	        console.log('EXPORT');
	        debugger;
	        this.cut(this.state.wavesurfer);
	      },

	      render: function render() {
	        return _react2['default'].createElement('div', { className: 'wavesurfer' }, 'wavesurfer ', this.getRegionLength(120, 4), _react2['default'].createElement('div', { id: 'wave' }), this.getButton('PLAY', this.playPause), this.getButton('EXPORT', this['export']), _react2['default'].createElement('br', null), this.getButton(' 1', this.play.bind(this, 0)), this.getButton(' 2', this.play.bind(this, 1)), this.getButton(' 3', this.play.bind(this, 2)), this.getButton(' 4', this.play.bind(this, 3)), _react2['default'].createElement('br', null), this.getButton(' 5', this.play.bind(this, 4)), this.getButton(' 6', this.play.bind(this, 5)), this.getButton(' 7', this.play.bind(this, 6)), this.getButton(' 8', this.play.bind(this, 7)), _react2['default'].createElement('br', null), this.getButton(' 9', this.play.bind(this, 8)), this.getButton('10', this.play.bind(this, 9)), this.getButton('11', this.play.bind(this, 10)), this.getButton('12', this.play.bind(this, 11)), _react2['default'].createElement('br', null), this.getButton('13', this.play.bind(this, 12)), this.getButton('14', this.play.bind(this, 13)), this.getButton('15', this.play.bind(this, 14)), this.getButton('16', this.play.bind(this, 15)), _react2['default'].createElement('br', null));
	      }
	    });
	    module.exports = exports['default'];
	    /* DRUM PADS */
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/x/react-web-pack-test/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot apply hot update to " + "wavesurfer.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
