...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    var _componentsPortfolio = __webpack_require__(226);

	    var _componentsPortfolio2 = _interopRequireDefault(_componentsPortfolio);

	    var _componentsPortfolioItem = __webpack_require__(227);

	    var _componentsPortfolioItem2 = _interopRequireDefault(_componentsPortfolioItem);

	    var _componentsNoMatch = __webpack_require__(228);

	    var _componentsNoMatch2 = _interopRequireDefault(_componentsNoMatch);

	    var _componentsApp = __webpack_require__(229);

	    var _componentsApp2 = _interopRequireDefault(_componentsApp);

	    var _componentsPage = __webpack_require__(231);

	    var _componentsPage2 = _interopRequireDefault(_componentsPage);

	    //DATA & Content

	    var _contentDataJson = __webpack_require__(232);

	    var _contentDataJson2 = _interopRequireDefault(_contentDataJson);

	    var _contentResumeMd = __webpack_require__(233);

	    var _contentResumeMd2 = _interopRequireDefault(_contentResumeMd);

	    (0, _reactDom.render)(_react2['default'].createElement(_reactRouter.Router, { history: document.location.hostname == "localhost" ? _reactRouter.hashHistory : _reactRouter.browserHistory }, _react2['default'].createElement(_reactRouter.Route, { path: '/',
	      component: _componentsApp2['default'],
	      header: _contentDataJson2['default'].headerContent.header,
	      subHeader: _contentDataJson2['default'].headerContent.subHeader,
	      routeLinks: [{
	        name: "Portfolio",
	        url: "/portfolio"
	      }, {
	      ...
	      footerLinks: _contentDataJson2['default'].footerLinks }, _react2['default'].createElement(_reactRouter.Route, { path: 'resume', component: _componentsPage2['default'], content: _contentResumeMd2['default'] }), _react2['default'].createElement(_reactRouter.Route, { path: 'portfolio', portfolioItems: _contentDataJson2['default'].portfolioItems, component: _componentsPortfolio2['default'] }, _react2['default'].createElement(_reactRouter.Route, { path: '/portfolio/:itemId', portfolioItems: _contentDataJson2['default'].portfolioItems, component: _componentsPortfolioItem2['default'] })), _react2['default'].createElement(_reactRouter.Route, { path: '*', component: _componentsNoMatch2['default'] }))), document.getElementById('root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    var _imagesHeaderImage1Png = __webpack_require__(230);
	    ...
	    var App = _react2['default'].createClass({
	      ...
	      getRouteLinks: function getRouteLinks(links) {
	        return links.map(function (link, index) {
	          return _react2['default'].createElement('li', { key: index }, _react2['default'].createElement(_reactRouter.Link, { to: link.url }, link.name));
	        });
	      },

	      getFooterLinks: function getFooterLinks(links) {
	        return links.map(function (link, index) {
	          return _react2['default'].createElement('li', { key: index }, _react2['default'].createElement('a', { href: link.url, className: 'hoverMe' }, link.name));
	        });
	      },

	      render: function render() {
	        return _react2['default'].createElement('div', null, _react2['default'].createElement('div', { className: 'row floating-text-parent' }, _react2['default'].createElement('div', { className: 'floating-text' }, _react2['default'].createElement('h1', null, this.props.route.header), _react2['default'].createElement('p', null, this.props.route.subHeader)), _react2['default'].createElement('img', { src: _imagesHeaderImage1Png2['default'] })), _react2['default'].createElement('div', { className: 'row' }, _react2['default'].createElement('ul', { className: 'menu' }, this.getRouteLinks(this.props.route.routeLinks))), _react2['default'].createElement('div', { className: 'row' }, this.props.children), _react2['default'].createElement('div', { className: 'row' }, _react2['default'].createElement('ul', { className: 'menu' }, this.getFooterLinks(this.props.route.footerLinks))));
	      }
	    });
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    var Page = _react2["default"].createClass({
	      ...
	      render: function render() {
	        return _react2["default"].createElement("div", { style: { padding: '2em' } }, _react2["default"].createElement("div", { dangerouslySetInnerHTML: { __html: this.props.route.content } }));
	      }
	    });
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/x/react-web-pack-test/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot apply hot update to " + "page.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
...
/***/ function(module, exports) {
	...
	module.exports = {
		"headerContent": {
			"header": "Patrick Kelly",
			"subHeader": "FrontEnd Developer, Designer, and Animator"
		},
		"footerLinks": [
			{
				"name": "Facebook",
				"url": "https://www.facebook.com/patricknolankelly"
			},
			{
				"name": "LinkedIn",
				"url": "https://www.linkedin.com/in/patomation"
			}
		],
		"portfolioItems": [
			{
...
/***/ function(module, exports) {
	...
	module.exports = "<h2 id=\"patrick-kelly\">Patrick Kelly</h2>\n<h4 id=\"profile-summary\">Profile | Summary</h4>\n<ul>\n<li>Over 5 years technical experience in web design and web development, with an emphasis on understanding customer requirements and work with engineering on those customer features for product releases, enabling pilot customers, reducing product escalations &amp; support costs, streamlining processes &amp; increasing efficiency of resources, effective product demos and project goals.</li>\n<li>Broad understanding of a variety of programming languages and able to quickly learn new languages and frameworks.</li>\n</ul>\n<table>\n<thead>\n<tr>\n<th><strong>∙</strong> Application Designer <strong>∙</strong> Product Development <strong>∙</strong> Web Development <strong>∙</strong> Google Analytics <strong>∙</strong> AWS &amp; Heroku <strong>∙</strong> ReST <strong>∙</strong> SaaS <strong>∙</strong> Html5 <strong>∙</strong> Javascript <strong>∙</strong> Python  <strong>∙</strong> Technical Training <strong>∙</strong> Technical Writer <strong>∙</strong> Brand Marketing <strong>∙</strong> Agile/Sprint/Stories <strong>∙</strong>  <strong> </strong> Information Technology</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td></td>\n</tr>\n</tbody>\n</table>\n<h4 id=\"professional-experience-\">Professional Experience:</h4>\n<p>Front End Developer<br><strong>Mixpo</strong><br>September 2014 - November 2015 (1 year 3 months)</p>\n<ul>\n<li>ShopIgniter was acquired by Mixpo. I continued my work creating UX interfaces for in-stream advertisements. Worked on company website. Helped maintain a utility library and reactjs component library complete with test coverage.</li>\n</ul>\n<p>Front End UX Developer<br><strong>ShopIgniter, Inc.</strong><br>June 2013 - September 2014 (1 year 4 months)</p>\n<ul>\n<li>Building custom themes and concepting new ideas for clients Creating reusable and extendable components Collaboration with other engineers and client services Handing API integrations such as Google Maps, SoundCloud and YouTube Handling Client Feedback and QA Bug fixes</li>\n<li>Constantly researching best practices for better code implementations</li>\n<li>Strong javascript experience including Jquery. Theming with HTML5, CSS3, LESS / SASS. Experience with nodeJS, Grunt and Compass for quick project development Experience Unix command line BASH and Shell Constant practice using tools such as Git</li>\n</ul>\n<p>Animator / Designer<br><strong>AngelVision Technologies / Darkwater Studios</strong><br>May 2011 - June 2013 (2 years 3 months)</p>\n<ul>\n<li>Designed and developed graphical user interface panels for adobe Flash Prepared media for for delivery on CD-ROM, trade shows and the internet Composited graphics video and audio for various national companies Created various scripts(javascript adobe api) to improve animation work flow Masking and retouching photos Rotoscoped and Keyed footage Created 3d models for compositing over video Animated and rigged characters in both 2D and 3D</li>\n</ul>\n<h4 id=\"education-training-and-community-service\">EDUCATION, TRAINING  and COMMUNITY SERVICE</h4>\n<p>Southern Oregon University.<br>Boys and Girls Club – 5 years<br>Screen Print Internship – 6 months</p>\n<h4 id=\"references\">REFERENCES</h4>\n<p>Available upon request</p>\n";
