...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    var ReactHotAPI = require("/x/weather-app/node_modules/react-hot-api/modules/index.js"),
	  ...
	  (function () {
	    ...
	    var _componentsSvgSvg = __webpack_require__(167);

	    var _componentsSvgSvg2 = _interopRequireDefault(_componentsSvgSvg);

	    var _componentsWeatherWeather = __webpack_require__(169);

	    var _componentsWeatherWeather2 = _interopRequireDefault(_componentsWeatherWeather);

	    //IMAGES

	    var _imagesCHAT2Gif = __webpack_require__(173);

	    var _imagesCHAT2Gif2 = _interopRequireDefault(_imagesCHAT2Gif);

	    var _imagesLogoutSvg = __webpack_require__(174);
	    ...
	    var App = _react2['default'].createClass({
	      ...
	      render: function render() {
	        return _react2['default'].createElement('div', { className: 'app' }, _react2['default'].createElement(_componentsLayoutLayout2['default'], {
	          ...
	          layoutStyle: this.styles.layout,
	          headerContent: 'Weather Comparision',
	          footerContent: 'by Patrick Kelly' }, _react2['default'].createElement(_componentsWeatherWeather2['default'], {
	  ...
	  if (false) {
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/x/weather-app/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html, body, #App, .app, .layout {\n  height: 100%; }\n\nhtml, body {\n  padding: 0;\n  margin: 0; }\n\nsvg {\n  width: 100%;\n  height: 100%; }\n\nsvg:hover path {\n  fill: green; }\n\n.verticalAlign {\n  position: absolute;\n  top: 50%;\n  -webkit-transform: translateY(-50%);\n  -ms-transform: translateY(-50%);\n  transform: translateY(-50%); }\n\ninput {\n  font-size: 16px;\n  box-sizing: border-box;\n  border: 0px; }\n\n@media (min-width: 641px) {\n  .weather {\n    max-width: 640px;\n    margin: 0 auto; } }\n", ""]);
	  ...
	  (function () {
	    ...
	    var Layout = _react2['default'].createClass({
	      ...
	      Props: {
	        ...
	        layoutStyle: _react2['default'].PropTypes.object,
	      ...
	      render: function render() {
	        ...
	        return _react2['default'].createElement('div', {
	          className: 'layout',
	          style: _utilities2['default'].merge(this.styles.layout, this.props.layoutStyle) }, _react2['default'].createElement(_header2['default'], {
	          style: _utilities2['default'].merge(this.styles.header, this.props.headerStyle) }, this.props.headerContent), _react2['default'].createElement('div', {
	          className: 'content',
	          style: _utilities2['default'].merge(this.styles.content, this.props.contentStyle) }, this.props.children), _react2['default'].createElement(_footer2['default'], {
	          style: _utilities2['default'].merge(this.styles.footer, this.props.footerStyle) }, this.props.footerContent));
	      }
	    });
	    ...
	    var Svg = _react2["default"].createClass({
	      ...
	      render: function render() {
	        return _react2["default"].createElement("div", {
	          ...
	          style: this.props.style }, _react2["default"].createElement("img", {
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/x/weather-app/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot apply hot update to " + "svg.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    var _difference = __webpack_require__(171);

	    var _difference2 = _interopRequireDefault(_difference);

	    var _gridGrid = __webpack_require__(172);
	    ...
	    var Weather = _react2['default'].createClass({
	      ...
	      setTemperatureOne: function setTemperatureOne(temperature) {
	        this.setState({
	          temperatureOne: temperature
	        });
	      },

	      setTemperatureTwo: function setTemperatureTwo(temperature) {
	        this.setState({
	          temperatureTwo: temperature
	        });
	      },

	      render: function render() {
	        return _react2['default'].createElement('div', { className: 'weather',
	          style: {
	            width: '100%',
	            height: '100%'
	          ...
	          temperatureCallback: this.setTemperatureOne }), _react2['default'].createElement(_difference2['default'], {
	          style: {
	            color: '#ffffff',
	            fontWeight: 'bold',
	            fontFamily: 'arial',
	          ...
	          temperatureOne: this.state.temperatureOne,
	          temperatureTwo: this.state.temperatureTwo }), _react2['default'].createElement(_location2['default'], {
	          apiKey: this.props.apiKey,
	          temperatureCallback: this.setTemperatureTwo })));
	      }
	    });
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/x/weather-app/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot apply hot update to " + "weather.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    var Location = _react2["default"].createClass({
	      ...
	      Props: {
	        temperatureCallback: _react2["default"].PropTypes.number
	      },
	      ...
	      getWeather: function getWeather() {
	        //Dont get conditions unless there are 5 digets
	        if (this.state.zip && this.state.zip.length === 5) {
	          _jquery2["default"].ajax({
	            url: "http://api.wunderground.com/api/625172310aff38a6/conditions/q/" + this.state.zip + ".json",
	            success: (function (result) {

	              //Set the state for this component
	              this.setState({
	                city: result.current_observation ? result.current_observation.display_location.city : null,
	                temperature: result.current_observation ? result.current_observation.temp_f : null,
	                icon: result.current_observation ? result.current_observation.icon_url.replace('/k', '/i') : null, //Force Icon Set #9
	                conditions: result.current_observation ? result.current_observation.weather : null
	              });

	              //Buble up temperater value to parent component
	              this.props.temperatureCallback(result.current_observation ? result.current_observation.temp_f : null);
	            }).bind(this)
	          });
	        }
	      },
	      ...
	      clearLocation: function clearLocation() {
	        ...
	        //Send null temp to callback
	        this.props.temperatureCallback(null);
	      },

	      //Input hotkey option
	      hotKey: function hotKey(keyCode, launchFunction, e) {
	        // If event keyCode parameter matches specified KeyCode launch function
	      ...
	      render: function render() {
	        ...
	        // Show Input
	        if (!this.state.city) {
	          content = _react2["default"].createElement("span", null, _react2["default"].createElement("input", {
	            style: this.styles.input,
	            onChange: this.handleChange.bind(this, 'zip'),
	            onKeyDown: this.hotKey.bind(this, 13, this.getWeather),
	            placeholder: "Zip Code" }), _react2["default"].createElement("button", {
	            style: this.styles.button,
	            onClick: this.getWeather }, "Go"));

	          // Show Results
	        } else {
	            content = _react2["default"].createElement("button", {
	              className: "location",
	              style: this.styles.locationButton,
	              onClick: this.clearLocation }, _react2["default"].createElement("p", null, this.state.city), _react2["default"].createElement("p", null, this.state.temperature, " ℉"), _react2["default"].createElement("img", { src: this.state.icon }), _react2["default"].createElement("p", null, this.state.conditions));
	          }

	        return _react2["default"].createElement("span", null, content);
	      }
	    });
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/x/weather-app/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot apply hot update to " + "location.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  ...
	  (function () {
	    ...
	    var Difference = _react2['default'].createClass({
	      displayName: 'Difference',

	      Props: {
	        temperatureOne: _react2['default'].PropTypes.number,
	        temperatureTwo: _react2['default'].PropTypes.number
	      },
	      ...
	      render: function render() {
	        var content = [];
	        if (this.props.temperatureOne && this.props.temperatureTwo) {
	          var temperatureDifference = Math.round(this.props.temperatureOne - this.props.temperatureTwo * 100) / 100;

	          content = _react2['default'].createElement('span', { className: 'difference',
	            style: _utilities2['default'].merge(this.style, this.props.style) }, _react2['default'].createElement('p', null, 'Difference'), _react2['default'].createElement('p', null, temperatureDifference, ' ℉'));
	        }
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/x/weather-app/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot apply hot update to " + "difference.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
	  ...
	  (function () {
	    ...
	    var Grid = _react2['default'].createClass({
	      ...
	      render: function render() {
	        ...
	        var gridItems = this.props.children.map((function (child, index) {

	          var style = _utilities2['default'].clone(this.styles.item);
	          style.width = 100 / this.props.children.length + '%';
	          style.left = index * 100 / this.props.children.length + '%';
	        ...
	        return _react2['default'].createElement('span', {
	          style: _utilities2['default'].merge(this.styles.container, this.props.style),
	          className: 'grid ' + this.props.className }, gridItems);
	      }
	    });
	    ...
	    (function () {
	      var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false;if (module.exports && module.makeHot) {
	        var makeExportsHot = require("/x/weather-app/node_modules/react-hot-loader/makeExportsHot.js");if (makeExportsHot(module, require("react"))) {
	          ...
	          module.hot.accept(function (err) {
	            if (err) {
	              console.error("Cannot apply hot update to " + "grid.js" + ": " + err.message);
	            }
	          });
	        }
	      }module.hot.dispose(function (data) {
